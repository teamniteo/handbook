...
* Every **Monday and Thursday** morning we hold a standup meeting:
   ...
   * followed immediately by separate standups for Easy Blog Networks and Pareto, synchronously in their own Zoom rooms
* Every other **Tuesday and Wednesday** morning we have [Scrum meetings](https://github.com/teamniteo/handbook/blob/master/2_Operations/scrum.md):
   ...
   * 12:00 UTC for the whole company in the Niteo Zoom room
   * followed immediately by separate meetings for Easy Blog Networks and Pareto, synchronously in their own Zoom rooms
 ...
 * A **Wednesday** is the start of a sprint with sprint planning.
   * 12:00 UTC for the whole company in the Niteo Zoom room
   * followed immediately by separate plannings for Easy Blog Networks and Pareto, synchronously in their own Zoom rooms
