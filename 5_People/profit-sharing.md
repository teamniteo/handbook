...
The profit is paid out if cash reserves are high enough to cover 12 months of expenses. We define the required reserves as 80% of the last 12 months' average expenses as we expect to be able to cut 20% if something were to go seriously wrong.
